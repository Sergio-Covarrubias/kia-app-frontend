  ...
  return (
    <div className="page-container md:p-20 justify-center items-center">
      <div className="w-full py-8 flex flex-col gap-y-5 flex-1 bg-white rounded-lg">
        ...
        <div className="flex-1 flex flex-col gap-y-5 justify-betweens">
          {/* Form data */}
...

            {
              !hasLoadedData ?
                ...
                formData.forms.map((form, index: number) => (
                  <Link to={ROUTES.FORM_EDIT(form.id)} key={index} className={`${ROW_CLASSNAME} cursor-pointer hover:bg-gray-200 transition duration-150 ease-in-out `}>
